            ...
            if new_nodes == 6:
                ...
                for LR_key in order:
                    ...
                    if ini == 'L':
                        ...
                        # 直交する辺の座標ペア
                        if num == 0:
                            choku_cords_1 = [cord2[num], cord2[new_nodes - 1]]
                        else:
                            choku_cords_1 = [cord2[num], cord2[num - 1]]
                        ...
                        if (num + 2) > (new_nodes - 1):
                            taiko_cords_1.append(cord2[num + 2 - new_nodes])
                        else:
                            taiko_cords_1.append(cord2[num + 2])
                        if (num + 3) > (new_nodes - 1):
                            taiko_cords_1.append(cord2[num + 2 - new_nodes + 1])
                        else:
                            taiko_cords_1.append(cord2[num + 3])
                ...
                for i in list(rect_1.values()):
                    ...
                    # tsuma_line =
                    # yane_type =
                    # f_make_roof(order, tsuma_line, yane_type)
                print(rect_1.values())
                print(rect_1_list)
