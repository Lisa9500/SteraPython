...
def f_build_start():
    ...
    def f_chokuko_angle(choku_cords, taiko_cords):
        # 直交する辺の両端座標（一方がL点）
        x1 = choku_cords[0][1]
        y1 = choku_cords[0][0]
        x2 = choku_cords[1][1]
    ...
    def octagonal_divider(cords):
        ...
        if arr_lr_p == ['L', 'R', 'L', 'R', 'R', 'R', 'R', 'R']:
            ...
            f_chokuko_angle(choku_cords_1, taiko_cords_1)
            int_1st_x = int_x
            int_1st_y = int_y
            # 交差角度が制限範囲内でない場合は処理を中断する
            # if theta < 60 or theta > 120:
            ...
            f_chokuko_angle(choku_cords_2, taiko_cords_2)
            int_2nd_x = int_x
            int_2nd_y = int_y
            # 交差角度が制限範囲内でない場合は処理を中断する
            # if theta < 60 or theta > 120:
            ...
            f_chokuko_angle(choku_cords_1a, taiko_cords_1a)
            int_1a_x = int_x
            int_1a_y = int_y
            # 交差角度が制限範囲内でない場合は処理を中断する
            # if theta < 60 or theta > 120:
            ...
            f_chokuko_angle(choku_cords_1b, taiko_cords_1b)
            int_1b_x = int_x
            int_1b_y = int_y
            # 交差角度が制限範囲内でない場合は処理を中断する
            # if theta < 60 or theta > 120:
            ...
            f_chokuko_angle(choku_cords_2a, taiko_cords_2a)
            int_2a_x = int_x
            int_2a_y = int_y
            # 交差角度が制限範囲内でない場合は処理を中断する
            # if theta < 60 or theta > 120:
            ...
            # 直交する直線1bと対向する辺との直交条件を確認する
            f_chokuko_angle(choku_cords_2b, taiko_cords_2b)
            int_2b_x = int_x
            int_2b_y = int_y
            # 交差角度が制限範囲内でない場合は処理を中断する
            # if theta < 60 or theta > 120:
            ...
            f_chokuko_angle(choku_cords_1ap, taiko_cords_1a_2_3)
            int1a_2_3x = int_x
            int1a_2_3y = int_y
            # 交差角度が制限範囲内かどうか確認する
            if 60 < theta < 120:
            ...
            # 直交する直線1aと対向する辺との交点を求める
            f_chokuko_angle(choku_cords_1ap, taiko_cords_1a_4_5)
            int1a_4_5x = int_x
            int1a_4_5y = int_y
            # 交差角度が制限範囲内かどうか確認する
            if 60 < theta < 120:
            ...
            f_chokuko_angle(choku_cords_1bn, taiko_cords_1b_3_4)
            int1b_3_4x = int_x
            int1b_3_4y = int_y
            # 交差角度が制限範囲内かどうか確認する
            if 60 < theta < 120:
            ...
            # 直交する直線1bと対向する辺との交点を求める
            f_chokuko_angle(choku_cords_1bn, taiko_cords_1b_5_6)
            int1b_5_6x = int_x
            int1b_5_6y = int_y
            # 交差角度が制限範囲内かどうか確認する
            if 60 < theta < 120:
            ...
            if flag_edge_2_3 == True and flag_edge_5_6 == True:
                ...
                # 直交する直線2bと対向する辺との交点を求める
                f_chokuko_angle(choku_cords_2bn, taiko_cords_2b_3_4)
                int2b_3_4x = int_x
                int2b_3_4y = int_y
                # 交差角度が制限範囲内かどうか確認する
                if 60 < theta < 120:
                ...
                # 直交する直線2aと対向する辺との交点を求める
                f_chokuko_angle(choku_cords_2ap, taiko_cords_2a_4_5)
                int2a_4_5x = int_x
                int2a_4_5y = int_y
                # 交差角度が制限範囲内かどうか確認する
                if 60 < theta < 120:
